...
export default function Appbar() {
  ...
  return (
    <div style={{zIndex:1000}} className={`${geistMono.className} px-4 py-3 pl-2 text-sm uppercase flex items-center sticky top-2 lg:top-6 mx-4 lg:mx-auto ${isAtTop?"lg:max-w-sm":"max-w-7xl"} lg:mx-auto transition-all duration-500 mb-2 justify-between gap-x-3 max-w-[1200px] backdrop-blur-2xl rounded-full`}>
        <div>
        ...
        <div className={`flex ${!isAtTop ? "lg:flex-1" : "flex-none"} justify-start items-center gap-x-4 transition-all duration-500`}>        
        {
            items.map((item,i)=>{
